...
import (
	...
	aesingflow_proxy "github.com/xtls/xray-core/proxy/aesingflow"
	hysteria_proxy "github.com/xtls/xray-core/proxy/hysteria"
	"github.com/xtls/xray-core/transport/internet"
	"github.com/xtls/xray-core/transport/internet/aesingflow"
...
func (w *tcpWorker) Start() error {
	...
	if v, ok := w.proxy.(*aesingflow_proxy.Server); ok {
		ctx = aesingflow.ContextWithInboundConfig(ctx, v.AesingFlowInboundConfig())
	}
